...
namespace App.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public ServicesController(ConstruxDbContext context)
        {
            _context = context;
        }
        ...
        {
            var construxDbContext = _context.Services.Include(s => s.Category).Include(s => s.Company);
            return View(await construxDbContext.ToListAsync());
        }
